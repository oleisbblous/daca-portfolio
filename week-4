Nädal 4 – olga individuaalne töö Roll C
...
Analüüsi põhjal on kõige suurema müügimahuga kategooria meeste_riided, kus müüdi kokku 4121 toodet. Kõige kõrgema keskmise hinnaga kategooria on jalanõusid (214,10 €), 
mis viitab sellele, et selles kategoorias müüakse kallimaid tooteid. Samal ajal on laste_riided madalaima keskmise hinnaga kategooria (85,30 €), kuid selle müügimaht on 
siiski väga hea, mis näitab stabiilset nõudlust. Kategooriate keskmine müüdud kogus toote kohta jääb vahemikku 1,78–1,84, mis tähendab, et müük on eri kategooriates 
üsna ühtlane. Annale soovitan hoida piisavat laovaru meeste riiete ja jalanõude kategooriates, sest nende müügimaht ja toodete väärtus on kõrged, ning jälgida regulaarselt 
kallimate toodete laoseisu, et vältida populaarsete toodete otsalõppemist.
...
ROUND(AVG(p.retail_price), 
2) AS keskmine_hind, MIN(p.retail_price) AS min_hind, 
...
SELECT p.category, SUM(s.quantity) AS muudud_kokku, 
